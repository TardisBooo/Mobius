...
export const demoHealth: HealthStatus = {
  database_path: "C:\\Users\\example\\AppData\\Local\\Mobius\\mobius.sqlite",
  contexts: 148,
  sessions: 92,
  notes: 31,
  boards: 8,
...
export const demoProjects: ProjectSummary[] = [
  { slug: "checkout", count: 54, latest_at: "2026-09-04T10:43:00Z" },
...
export const demoHits: ContextHit[] = [
  {
    id: "session:codex:checkout-arch",
    kind: "session",
    agent: "codex",
    ...
    snippet: "The source session stays untouched while Möbius owns its normalized index and durable notes.",
    source_path: "C:\\Users\\example\\.codex\\sessions\\architecture.jsonl",
  ...
  },
  {
    ...
    source_path: "C:\\Users\\example\\AppData\\Local\\Mobius\\vault\\notes\\context-contract.md",
  ...
  },
  {
    ...
    source_path: "C:\\Users\\example\\AppData\\Local\\Mobius\\vault\\boards\\knowledge-map.json",
  ...
  },
  {
    ...
    source_path: "C:\\Users\\example\\.claude\\projects\\sync-protocol\\session.jsonl",
...
export const demoSkills: SkillInfo[] = [
  {
    id: "skill:repo-scout",
    name: "repo-scout",
    source_path: "C:\\Users\\example\\.agents\\skills\\repo-scout\\SKILL.md",
    source_kind: "local",
  ...
  },
  {
    id: "skill:wiki",
    name: "wiki",
    source_path: "C:\\Users\\example\\projects\\checkout\\.agents\\skills\\wiki\\SKILL.md",
    source_kind: "local",
  ...
  },
  {
    id: "skill:research",
    name: "research",
    source_path: "C:\\Users\\example\\.codex\\skills\\research-zh\\SKILL.md",
    source_kind: "codex",
...
export const demoAgents: AgentStatus[] = [
  ...
  { id: "pi", label: "Pi", status: "needs_setup", sessions: 0, detail: "Add Möbius MCP command" },
];

export const demoWikiQueue: WikiQueueItem[] = [
  {
    id: "wiki-queue:preview-1",
    source_context_id: "session:codex:checkout-arch",
    state: "queued",
