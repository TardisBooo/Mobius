...
function labels(locale: Locale) {
  ...
  return {
    ...
    close: zh ? "关闭" : "Close", selected: zh ? "已选消息" : "Selected message", projectSessions: zh ? "工作区会话" : "Workspace sessions",
