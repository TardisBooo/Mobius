...
[English](README.md) · [在线产品页](http://8.137.87.76/mobius/?lang=zh) · [播放产品视频](http://8.137.87.76/mobius/?lang=zh#demo) · [下载](https://github.com/TardisBooo/Mobius/releases/tag/v0.3.16) · [完整验收记录](docs/acceptance/drag-demo-0.3.16.md) · [MIT License](LICENSE)
...
- **语义／向量与混合检索：v0.3.16 尚未提供。** 当前未接入 embedding 模型或向量后端，这是后续能力，不是可在设置中开启的现成功能；Mome 会明确显示当前仅为词法检索。
...
从 [GitHub Releases](https://github.com/TardisBooo/Mobius/releases/tag/v0.3.16) 下载 v0.3.16 Windows 预览版安装包或便携 EXE，并核对 SHA-256 和已知限制。构建尚未签名，可能触发 SmartScreen。

参见 [0.3.16 drag-demo 验收](docs/acceptance/drag-demo-0.3.16.md)。MÖBIUS 只通过各 Harness 公开的命令行接口调用已安装程序，不会修改或替换 Codex、Claude Code、Pi、Grok 与 OMP。
